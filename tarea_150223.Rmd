...
for(i in rango_num){
  print(paste0("mod_",colnames(data_num)[i]))
  print(summary(assign(paste0("mod_",colnames(data_num)[i]), 
                       glm(target ~ data_num_norm[,i], 
                           family = binomial(link = "logit"))))$coefficients)
}

for(i in rango_fac){
  print(paste0("mod_",colnames(data_fac)[i]))
  print(summary(assign(paste0("mod_",colnames(data_fac)[i]),
                       glm(target ~ data_fac[,i],
                           family = binomial(link = "logit"))))$coefficients)
}
```
